  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        success:
          "success group border-green-500 bg-green-50 text-green-700 dark:bg-green-950 dark:text-green-300",
        warning:
          "warning group border-yellow-500 bg-yellow-50 text-yellow-700 dark:bg-yellow-950 dark:text-yellow-300",
        info:
          "info group border-blue-500 bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
// Toast icon component that displays different icons based on variant
...
>(({ variant = "default", ...props }, ref) => {
  ...
  return (
    <div ref={ref} className="mr-3 flex-shrink-0" {...props}>
      {icons[variant]}
    </div>
  )
})
